...
public final class QuoteSyncJob {
    ...
    private static final String ACTION_DATA_UPDATED = "com.warungkopidigital.penjualkopi.stockhawkjenal.ACTION_DATA_UPDATED";
                ...
                client.newCall(request).enqueue(new Callback() {
                    ...
                    public void onResponse(Call call, Response response) throws IOException {
                        try {
                            ...
                            Log.e("isi data", body);
//                            Toast.makeText(,body,Toast.LENGTH_LONG).show();
    ...
    static void getQuotesDetail(final Context context) {
...
//                            Toast.makeText(,body,Toast.LENGTH_LONG).show();
    ...
    public static synchronized void initializeGetDetail(final Context context) {
